...
const myJSONResume = {
  basics: {
    name: 'Mikko Seppänen',
    label: 'Student at JAMK University of Applied Sciences',
    picture: './kuvaminusta.jpg',
    // email: 'erlich@piedpiper.com',
    phone: '045 677 00 48',
    summary: 'Studying Cyber Security at JAMK for a third year, looking for a trainee position',
    location: {
